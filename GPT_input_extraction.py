...
input_file_path = './sentence_input_entities.json'
output_relation_file_path = './test_input_data.csv'
...
def GPT_relation_extraction(_sentence : str, _entity_list : list , _filter: bool = True) -> list:
    ...
    "\n例如:" + \
    "\n給定句子 : 美国参议院针对今天总统布什所提名的谁展开了认可听证会？并预料她将会很顺利通过参议院支持，成为该国有史以来第一位的华裔女性内阁成员。" + \
    "\n主语和宾语列表：[ '布什'，'谁'，'参议院']" + \
    "\nSPO三元组：[['布什'，'提名'，'谁']，['参议院'，'展开认可听证会'，'谁']]" + \
